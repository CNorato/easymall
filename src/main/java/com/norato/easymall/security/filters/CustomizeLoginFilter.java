...
public class CustomizeLoginFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public CustomizeLoginFilter(String path) {
        super(new AntPathRequestMatcher(path, "POST"));
    }

    public CustomizeLoginFilter(String path, AuthenticationManager authenticationManager) {
